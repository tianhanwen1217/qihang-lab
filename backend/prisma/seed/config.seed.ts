...
export const configVariables = {
  ...
  general: {
    ...
    appUrl: {
      type: "string",
      defaultValue: "https://qihang-lab.xyz",
      secret: false,
    },
    secureCookies: {
      type: "boolean",
  ...
  email: {
    ...
    inviteSubject: {
      type: "string",
      defaultValue: "起航实验室 - 邀请",
    },
    inviteMessage: {
      type: "text",
      defaultValue:
        'Hey!\n\nYou were invited to 起航实验室. Click this link to accept the invite: {url}\n\nYou can use the email "{email}" and the password "{password}" to sign in.\n\n起航实验室 🚀',
    },
  },
  smtp: {
    enabled: {
